 ...
 * @author Julia
 */
public class SantaBodyProcessor implements BodyProcessor {
    private final BodyFactory bodyFactory;
    private final World world;
    private Direction lastKnownDirection;

    public SantaBodyProcessor(final World world, final BodyEditorLoader loader) {
        if (world == null) {
            throw new IllegalArgumentException("'world' cannot be null");
        }
        this.bodyFactory = new SantaBodyFactory(loader);
        this.world = world;
    }
