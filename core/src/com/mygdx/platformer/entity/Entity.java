...
public abstract class Entity implements Disposable {
     ...
     */
    private final StateMachine<Entity,State<Entity>> stateMachine;
    ...
    public Entity(final GraphicsProcessor graphics, final PhysicsProcessor physics) {
        this(graphics, physics, null);
    }

    public Entity(final GraphicsProcessor graphics, final PhysicsProcessor physics, final State<Entity> initialState) {
        this.graphics = graphics;
        this.physics = physics;
        stateMachine = new DefaultStateMachine<Entity,State<Entity>>(this, initialState);
    }
